...
export default function RegisterPage() {
  return (
    <div className="min-h-screen bg-[#f7f8fb] flex flex-col font-poppins">
      {/* Top Curved Shape */}
      ...
      <main className="flex-1 flex flex-col items-center px-4">
        ...
        <div className="w-full max-w-4xl -mt-32 lg:-mt-40 bg-white rounded-xl p-6 lg:p-12 shadow-2xl z-10 mb-8">
